                        ...
                        {invoices.length > 0 ? (
                            invoices.map((invoice) => (
                                ...
                                >
                                    ...
                                    <td className="border px-6 py-4">{invoice.totalAmount.toLocaleString()} VND</td>
                                    <td className="border px-6 py-4">{invoice.status}</td> {/* Hiển thị trạng thái */}
                                    <td className="border px-6 py-4 flex justify-center gap-2">
                                        ...
                                        <button
                                            onClick={() => handleDeleteInvoice(invoice._id)}
                                            className="bg-yellow-500 text-white px-4 py-2 rounded shadow hover:bg-red-600"
                                        >
                                            Thanh toán
                                        </button>
                                    </td>
                            ...
                            <tr>
                                <td
                                    colSpan="5" // Cập nhật số cột để phù hợp
