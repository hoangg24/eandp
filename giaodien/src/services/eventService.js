...
export const createEvent = async (data) => {
    try {
        const response = await axios.post(`${API_URL}/create`, data, getAuthHeaders());
        return response.data;
    } catch (error) {
...
export const addServiceToEvent = async (eventId, serviceData) => {
    try {
        const response = await axios.put(`${API_URL}/${eventId}/add-service`, serviceData, getAuthHeaders());
        return response.data;
    } catch (error) {
...
export const updateEvent = async (eventId, updatedData) => {
    try {
        const response = await axios.put(`${API_URL}/${eventId}`, updatedData, getAuthHeaders());
        return response.data;
    } catch (error) {
